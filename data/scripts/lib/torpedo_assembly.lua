...
function TorpedoAssembly.initTorpDesigner(tab, section)
	...
	TorpedoAssembly.customLabel(tab, section, "TORPEDO ASSEMBLY SETTINGS")
	TorpedoAssembly.customText(tab, section, 16, 27, 125, 23, "Torpedo Body", 13)
	TorpedoAssembly.customText(tab, section, 16, 53, 125, 23, "Torpedo Warhead", 13)
	TorpedoAssembly.customText(tab, section, 16, 79, 125, 23, "Torpedo Rarity", 13)
	...
	btnDesignerProto = TorpedoAssembly.customButton(tab, section, 16, 110, 110, 25, "DESIGN", "actionValidateDesign")
	btnDesignerSave = TorpedoAssembly.customButton(tab, section, 136, 110, 80, 25, "SAVE", "actionSaveDesign")
	btnDesignerReset = TorpedoAssembly.customButton(tab, section, 226, 110, 110, 25, "RESET", "actionResetDesign")
...
function TorpedoAssembly.initTorpBlueprints(tab, section)
	...
	TorpedoAssembly.customFrame(tab, section)
	TorpedoAssembly.customLabel(tab, section, "SAVED TORPEDO DESIGNS")
	listTorpDesigns = TorpedoAssembly.customListBox(tab, section, 16, 26, 319, 317)
	btnDesignerDelete = TorpedoAssembly.customButton(tab, section, 60, 356, 110, 25, "DELETE", "actionDeleteDesign")
	btnDesignerReload = TorpedoAssembly.customButton(tab, section, 180, 356, 110, 25, "RELOAD", "actionReloadDesigns", true)
...
function TorpedoAssembly.initTorpLaunchShaft(tab, section)
	TorpedoAssembly.customFrame(tab, section)
	TorpedoAssembly.customLabel(tab, section, "TORPEDO CAPACITY OVERVIEW")
	torpShafts.tShaft[1] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 23, 75, 20, "Shaft #01:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[2] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 45, 75, 20, "Shaft #02:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[3] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 67, 75, 20, "Shaft #03:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[4] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 89, 75, 20, "Shaft #04:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[5] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 111, 75, 20, "Shaft #05:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[6] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextSt(tab, torpShafts.tShaft[1].localRect, 15, 0, 75, 20, "Shaft #06:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[7] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextSt(tab, torpShafts.tShaft[2].localRect, 15, 0, 75, 20, "Shaft #07:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[8] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextSt(tab, torpShafts.tShaft[3].localRect, 15, 0, 75, 20, "Shaft #08:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[9] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextSt(tab, torpShafts.tShaft[4].localRect, 15, 0, 75, 20, "Shaft #09:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tShaft[10] = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextSt(tab, torpShafts.tShaft[5].localRect, 15, 0, 75, 20, "Shaft #10:", 13).localRect, 75, 20, "", 13, true, -1)
	torpShafts.tStorage = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 133, 120, 20, "Torpedo Storage:", 13).localRect, 195, 20, "", 13, true, -1)
end

function TorpedoAssembly.initTorpCraftStats(tab, section)
	TorpedoAssembly.customFrame(tab, section)
	TorpedoAssembly.customLabel(tab, section, "TORPEDO ASSEMBLY STATS")
	torpStats.tName = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 24, 50, 20, "Name:", 12).localRect, 300, 20, "", 12, true)
	torpStats.tRarity = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 46, 105, 20, "Rarity/Grade:", 12).localRect, 80, 20, "", 12, true)
	torpStats.tDamageType = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 68, 105, 20, "Damage Type:", 12).localRect, 80, 20, "", 12, true)
	torpStats.tDamageHull = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 90, 105, 20, "Hull Damage:", 12).localRect, 80, 20, "", 12, true)
	torpStats.tDamageShield = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 112, 105, 20, "Shield Damage:", 12).localRect, 80, 20, "", 12, true)
	torpStats.tVelFactor = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customText(tab, section, 15, 134, 105, 20, "Velocity Factor:", 12).localRect, 80, 20, "", 12, true)
	torpStats.tSize = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tName.localRect, 20, 0, 40, 20, "Size:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tTech = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tSize.localRect, 20, 0, 75, 20, "Tech Level:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tDurability = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tRarity.localRect, 20, 0, 105, 20, "Durability:", 12).localRect, 75, 20, "", 12, true)
	torpStats.tAcceleration = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tDamageType.localRect, 20, 0, 105, 20, "Acceleration:", 12).localRect, 75, 20, "", 12, true)
	torpStats.tTurnSpeed = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tDamageHull.localRect, 20, 0, 105, 20, "Maneuverability:", 12).localRect, 75, 20, "", 12, true)
	torpStats.tMaxVelocity = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tDamageShield.localRect, 20, 0, 105, 20, "Max. Velocity:", 12).localRect, 75, 20, "", 12, true)
	torpStats.tMaxRange = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tVelFactor.localRect, 20, 0, 105, 20, "Max. Range:", 12).localRect, 75, 20, "", 12, true)
	torpStats.tPenetrator = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tDurability.localRect, 20, 0, 140, 20, "Penetrates Shield:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tDeactivator = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tAcceleration.localRect, 20, 0, 140, 20, "Deactivates Shield:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tDamageCombo = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tTurnSpeed.localRect, 20, 0, 140, 20, "Shield/Hull Damage:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tEnergyDrain = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tMaxVelocity.localRect, 20, 0, 140, 20, "Drains Energy:", 12).localRect, 40, 20, "", 12, true)
	torpStats.tEnergyUse = TorpedoAssembly.customTextRt(tab, TorpedoAssembly.customTextSt(tab, torpStats.tMaxRange.localRect, 20, 0, 105, 20, "Energy Usage:", 12).localRect, 75, 20, "", 12, true)
...
function TorpedoAssembly.initTorpCraftManager(tab, section)
	TorpedoAssembly.customFrame(tab, section)
	TorpedoAssembly.customLabel(tab, section, "TORPEDO ASSEMBLY CONTROL")
	btnAssemblerAdd = TorpedoAssembly.customButton(tab, section, 206, 26, 110, 25, "ADD", "actionProdAdd", false)
	btnAssemblerRemove = TorpedoAssembly.customButton(tab, section, 206, 62, 110, 25, "REMOVE", "actionProdRemove", false)
	btnAssemblerStop = TorpedoAssembly.customButton(tab, section, 206, 98, 110, 25, "STOP", "actionProdStop", false)
	btnAssemblerRepeat = TorpedoAssembly.customButton(tab, section, 206, 134, 110, 25, "REPEAT", "actionProdRepeat", false)
	...
	torpFactory.pProdCap = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 25, 125, 20, "Production Speed:", 13).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pProdLines = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 47, 125, 20, "Production Lines:", 13).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pProdEff = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 69, 125, 20, "Required Effort:", 13).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pProdTime = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customText(tab, section, 15, 91, 125, 20, "Production Time:", 13).localRect, 50, 20, "", 13, true, -1)
	...
	torpFactory.pCostFe = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 16, 147, 85, 20, "Iron Cost:", 13, mColor.Iron).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostTi = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 16, 169, 85, 20, "Titan. Cost:", 13, mColor.Titanium).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostTr = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 16, 191, 85, 20, "Trin. Cost:", 13, mColor.Trinium).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostOg = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 16, 213, 85, 20, "Ogon. Cost:", 13, mColor.Ogonite).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostNa = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 176, 169, 85, 20, "Naon. Cost:", 13, mColor.Naonite).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostXa = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 176, 191, 85, 20, "Xan. Cost:", 13, mColor.Xanion).localRect, 50, 20, "", 13, true, -1)
	torpFactory.pCostAv = TorpedoAssembly.customTextRc(tab, TorpedoAssembly.customTextClr(tab, section, 176, 213, 85, 20, "Avor. Cost:", 13, mColor.Avorion).localRect, 50, 20, "", 13, true, -1)
